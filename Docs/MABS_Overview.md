...
* `MABSGameplay` owns granting, activation, delivery, effects, combo runtime, AoE resolution, periodic timers, cue routing, replication, projectile runtime, and debug summary accessors through real private runtime units behind `UMABSAbilityComponent`
